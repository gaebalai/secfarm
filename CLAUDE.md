...
Secfarm supports MCP to integrate external tools and services into the chat analysis workflow.
...
Secfarm supports BigQuery as a tool for querying log data during chat analysis. This enables LLM to generate and execute SQL queries based on natural language requests.
