...
type PlanUpdate struct {
	...
	Step   Step       `json:"step,omitempty"`    // 단계 정보 (add_step/update_step인 경우)
	StepID string     `json:"step_id,omitempty"` // 단계 ID (cancel_step인 경우)
	Reason string     `json:"reason,omitempty"`  // 취소 사유 (cancel_step인 경우)
}
